...
from language_model_gateway.gateway.structures.openai.message.chat_completion_message_wrapper import (
...
from language_model_gateway.gateway.structures.openai.message.responses_message_wrapper import (
