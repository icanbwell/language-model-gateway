...
@pytest.mark.asyncio
async def test_chat_completions_with_mcp_url_to_markdown(
    ...
    await model_configuration_cache.set(
        [
            ChatModelConfig(
                ...
                tools=[
                    AgentConfig(
                        name="mcp_url_to_markdown",
                        url="http://url_to_markdown:8003/mcp/",  # Assumes MCP server is running locally
                        headers={},
                    ),
                ],
            )
    ...
    message: ChatCompletionUserMessageParam = {
        "role": "user",
        "content": "Convert the content at https://www.example.com to markdown.",
    }
